...
public enum Formatting {
    ...
    private static final Map<String, Formatting> NAME_MAPPING = Maps.<String, Formatting>newHashMap();
    /**
    ...
    {
        return friendlyName == null ? null : (Formatting)NAME_MAPPING.get(lowercaseAlpha(friendlyName));
    }

    /**
     * Get a Formatting from it's color index
     */
    @Nullable
